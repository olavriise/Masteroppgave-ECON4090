...
esttab using filnavn.tex, b(3) se(3) r2 nomtitle label keep(outsourcet alder alder2 kvinne innvandrer lavutdannet yrknum)
eststo clear

esttab using filnavn.tex, b(3) se(3) r2 nomtitle label drop(2018.aarnum 2017.aarnum 2016.aarnum 2015.aarnum 2014.aarnum 2013.aarnum 2012.aarnum 2011.aarnum 2010.aarnum 2009.aarnum 2008.aarnum 2007.aarnum 2006.aarnum 2005.aarnum 2004.aarnum)
...
esttab using filnavn.tex, b(3) se(3) r2 nomtitle label keep(outsourcet alder alder2 kvinne innvandrer lavutdannet kokk)
eststo clear
...
esttab using filnavn.tex, b(3) se(3) r2 nomtitle label keep(outsourcet alder alder2 kvinne innvandrer lavutdannet)
eststo clear
...
esttab using filnavn.tex, b(3) se(3) r2 nomtitle label keep(outsourcet alder alder2 kvinne innvandrer lavutdannet vekter)
eststo clear
...
esttab using filnavn.tex, b(3) se(3) r2 nomtitle label keep(outsourcet alder alder2 kvinne lavutdannet)
eststo clear
...
esttab using filnavn.tex, b(3) se(3) r2 nomtitle label keep(outsourcet alder alder2 innvandrer lavutdannet)
eststo clear
